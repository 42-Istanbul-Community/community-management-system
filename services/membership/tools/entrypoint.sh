...
export DATABASE_URL="postgresql://${POSTGRES_USER}:${DB_PASSWORD}@postgres-membership:5432/${POSTGRES_DB}?schema=public"

export PSQL_URL="postgresql://${POSTGRES_USER}:${DB_PASSWORD}@postgres-membership:5432/${POSTGRES_DB}"

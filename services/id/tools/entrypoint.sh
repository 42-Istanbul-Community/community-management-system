...
export RUSTFS_ACCESS_KEY="$(cat /run/secrets/rustfs_id_access_key)"
export RUSTFS_SECRET_KEY="$(cat /run/secrets/rustfs_id_secret_key)"
...
export PSQL_URL="postgresql://${POSTGRES_USER}:${DB_PASSWORD}@postgres-id:5432/${POSTGRES_DB}"
